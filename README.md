...
Проект создан для практики построения MVP-архитектуры веб-приложения на классах JavaScript с использованием TypeScript. В ходе выполнения проекта была спроектирована и задокументирована архитектура с разделением модели и отображения через брокер событий, созданы необходимые типы данных и интерфейсы классов, классы модели данных и компонентов отображения.

<img src="./docs/Catalog.png" alt="Каталог товаров" width="1000">

Макет: [Figma](https://www.figma.com/file/50YEgxY8IYDYj7UQu7yChb/%D0%92%D0%B5%D0%B1-%D0%BB%D0%B0%D1%80%D1%91%D0%BA?type=design&node-id=0%3A1&mode=design&t=hsaQi5jbymEwahWc-1).
